...
const BottomPanel = () => {
    ...
    return (
        <Grid className="margin-center bottom-actions" container sx={{width:{lg: "50vw",xs: "65vw"}, maxWidth:{lg: "60vw",md: "70vw",sm: "70vw",xs: "70vw"}, bottom:{lg: "-3vh",md: "-30vh",sm: "-20vh",xs: "-20vh"}}}>
            <Grid onClick={() => history.push('/123')} className="margin-center" item sm={2} xs={2} md={2}>
            ...
            <Grid className="margin-center" item sm={2} xs={2} md={2}>
            ...
            <Grid onClick={() => history.push('/profile')} className="margin-center" item sm={2} xs={2} md={2}>
            ...
            <Grid className="margin-center" item sm={2} xs={2} md={2}></Grid>
