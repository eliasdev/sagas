...
import insigniaDescartes from './../.././assets/badges/descartes-badge.png';
import insigniaEinstein from './../.././assets/badges/einstein-badge.png';
import insigniaTharp from './../.././assets/badges/tharp-badge.png';
import insigniaClodomiro from './../.././assets/badges/clodomiro-badge.png';
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <main>
        <Typography
          variant="h1"
          sx={{ padding: { lg: 6, xs: 4 }, fontSize: { lg: 50, xs: 25 } }}
          align="left"
        >
          Perfil de Usuario
        </Typography>
        ...
        <Typography
          sx={{ fontSize: { lg: 22, xs: 15 }, paddingLeft: 2.5, width: '80%' }}
          align="left"
          paragraph
        >
          ...
          misiones para que nuestros niños puedan practicar la materia de clase,
        ...
        <Grid sx={{ padding: 2 }}>
          ...
          <Typography
            variant="h3"
            sx={{ padding: { lg: 5, xs: 2 }, fontSize: { lg: 28, xs: 25 } }}
            align="left"
          >
            INSIGNIAS OBTENIDAS
          </Typography>
          ...
          <Grid sx={{ padding: { lg: 5, xs: 2 } }} lg={12} sm={12} container>
            {user?.descartes && (
              <Grid lg={3}>
                <ListItem>
                  <ListItemAvatar>
                    <img src={insigniaDescartes} width={100} />
                  </ListItemAvatar>
                </ListItem>
              </Grid>
            )}
            ...
            {user?.einstein && (
              <Grid lg={3}>
                <ListItem>
                  <ListItemAvatar>
                    <img src={insigniaEinstein} width={100} />
                  </ListItemAvatar>
                </ListItem>
              </Grid>
            )}
            ...
            {user?.tharp && (
              <Grid lg={3}>
                <ListItem>
                  <ListItemAvatar>
                    <img src={insigniaTharp} width={100} />
                  </ListItemAvatar>
                </ListItem>
              </Grid>
            )}
            ...
            {user?.clodomiro && (
              <Grid lg={3}>
                <ListItem>
                  <ListItemAvatar>
                    <img src={insigniaClodomiro} width={100} />
                  </ListItemAvatar>
                </ListItem>
              </Grid>
            )}
